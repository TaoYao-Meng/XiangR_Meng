        ...
        <div id="left">
                   ...
                   <div id="box2">
                       ...
                       <ul class='first_ul'>
                           ...
                           <li><a href="cart_action!read" target="rightframe">我的购物车</a></li>
                           <li><a href="own_action?shan=<s:property value="#session.no"/>" target="rightframe">我的商店</a></li>
                       </ul>
                       <ul>
                           <span class="m">车辆信息<b>+</b></span>
                           <li><a href="car_action.action" target="rightframe">综合</a></li>
                           <li><a href="car_action?back=price_up" target="rightframe">价格升序</a> </li>
                       ...
                       <ul class='last_ul'>
                           ...
                           <li><form action="friend_action!find" method="post" target="rightframe">用户查找:<input type="text" name="back" /><input type="submit"/> </form></li>
                           <li><a href="apply_action" target="rightframe">好友请求</a></li>
